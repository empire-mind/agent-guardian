...
Python 3.8+. The tool itself is stdlib-only — no install step:

```bash
git clone https://github.com/empire-mind/agent-guardian.git
cd agent-guardian
python3 examples/hello-guardian.py   # the tour
python3 -m pytest tests/             # test suite (pytest is test-only)
```
